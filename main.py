...
message_label = tk.Label(root, textvariable=content_describer.message_var, wraplength=1000)
message_label.pack()

video_handler.start_stream()

root.protocol("WM_DELETE_WINDOW", content_describer.on_closing)  # Handle window close event
